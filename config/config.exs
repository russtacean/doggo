...
config :doggo, DoggoWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: DoggoWeb.ErrorHTML, json: DoggoWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: Doggo.PubSub,
  live_view: [signing_salt: "b+KxczD8"]
...
config :doggo, Doggo.Mailer, adapter: Swoosh.Adapters.Local
...
# Configure Petal Components to use our error translation function
config :petal_components,
       :error_translator_function,
       {DoggoWeb.CoreComponents, :translate_error}
