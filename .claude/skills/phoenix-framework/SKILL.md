...
description: "Use this skill when working with Phoenix, LiveView, HEEx templates, Ecto, forms, or any web layer code. Always consult this when building features that involve routes, controllers, views, or templates."
metadata:
